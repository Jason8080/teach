...
​		Apache Subversion 通常被缩写成 SVN，是一个开放源代码的 **集中式** 版本控制系统，Subversion 在 2000 年由 CollabNet Inc 开发，现在发展成为 Apache 软件基金会的一个项目，同样是一个丰富的开发者和用户社区的一部分。

##### 1.2 作用

- 记录文件修改日志: `git log`
  - 1		新增需求12345		用户A		2018/01/01 12:00:01		对比差异
  - 2		修改需求12346		用户B		2018/01/01 12:09:01		对比差异
  - 3		修改需求12347		用户A		2019/01/10 23:00:01		对比差异
- 还原变更的需求
  - 还原被修改的文件: `git reset --hard`
  - 回滚到指定的版本: `git reset --hard  b498237e6dc1fc4861c79d3314d07285995b`
- 方便团队协同开发
  - 版本1 和 版本2可以通过合并选择最佳方案
  - 修改需求12346
...
- 2005年, Git在Linus长达两周的研发中诞生, 即刻便用于Linux代码管理, 从此Git成为主流
...
> ​	GitLab是一个用于仓库管理系统的 **开源项目**, 使用Git作为代码管理工具, 在此基础上搭建起来的web服务。
>
